...
router.get('/modeling/:companyId', validateToken, stockControllers.getModelingNote)
...
router.post('/modeling/:companyId', validateAdmin, stockControllers.createModelingNote)
router.post('/portfolio/:companyId/:futurePrice', validateToken, stockControllers.addToPortfolio)
router.post('/thesis-llm/fill', stockControllers.createThesisWithLLM)
