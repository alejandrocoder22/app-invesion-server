export const defaultStrategy = (allScoreMetrics) => {
  ...
  const scoreRules = [
    ...
    {
      condition: () =>
        Number(lastFiveYearsROIC) < 15 && Number(lastFiveYearsROIC) > 12,
      score: 12.5,
    },
    {
      condition: () =>
        Number(lastFiveYearsROIC) < 12 && Number(lastFiveYearsROIC) > 10,
      score: 10,
    },
    {
  ...
  const payoutRatioSpecificRules = [
    ...
    {
      condition: () =>
        tenYearsDividendGrowth === "NaN" || anualisedEPS === null,
      score: 5,
    },
    {
